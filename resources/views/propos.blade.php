...
<body>
    ...
    <nav class="navBarre">
        ...
        <ul class="list-group">
            <li class="list-group-item"><a class='link-list-group' href="{{route('welcome')}}">Présentation des awards</a></li>
            ...
            <li class="list-group-item"><a class='link-list-group' href="{{route('a_propos')}}" style="color: #FFB700;">À propos</a></li>
        </ul>
    ...
    <footer class='footer'>
        ...
        <ul>
            <li><a class="footerLink" href="{{route('welcome')}}">Presentation des awards</a></li>
            <li><a class="footerLink" href="{{route('vote')}}">Vote</a></li>
            <li><a class="footerLink" href="#">ChatBox</a></li>
            <li><a class="footerLink" href="{{route('a_propos')}}" style="color: #FFB700">À propos</a></li>
        </ul> <hr />
