...
<body>
    ...
    <nav class="navBarre">
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item"><a class='link-list-group' href='{{route('vote')}}' style="color: #FFB700;">Vote</a></li>
    ...
    <footer class='footer'>
        ...
        <ul>
            ...
            <li><a class="footerLink" href="{{route('vote')}}" style="color: #FFB700">Vote</a></li>
